...
<div class="container">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4" style="font-weight: bold">UPDATE DETAIL DISHCATEGORY</h1>
                                </div>

                                <form class="user" action="DishCategoryServlet?action=update" method="POST">
                                    ...
                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 15%; margin:auto">Category name:</span><input type="text" name="name" required="true" pattern=".{0,30}" value="${d.name}"class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Name Caterogy..." style="width:85%">
                                    </div>
