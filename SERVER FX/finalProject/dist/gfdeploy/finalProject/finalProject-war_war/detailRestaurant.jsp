...
<div class="container">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4" style="font-weight: bold">UPDATE DETAIL RESTAURANT</h1>
                                </div>

                                <form class="user" action="RestaurantServlet?action=update" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 15%; margin:auto">name:</span><input type="text" name="fullname" required="true" pattern=".{0,30}" value="${d.fullName}"class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Name Caterogy..." style="width:85%">
                                    </div>
                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 15%; margin:auto">Email:</span><input type="text" value="${d.email}" name="email"  pattern=".{0,30}"class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email..." style="width:85%" required="true">
                                    </div>
                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 15%; margin:auto">Phone</span><input type="text" value="${d.phoneNumber}" name="phoneNumber"  pattern=".{0,30}"class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter..." style="width:85%" required="true">
                                    </div>
                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 15%; margin:auto">Rate</span><input type="text" name="rateTotal" value="${d.rateTotal}"  pattern=".{0,30}"class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter..." style="width:85%" required="true">
                                    </div>
