...
<div class="container">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4" style="font-weight: bold">INSERT DISH</h1>
                                </div>

                                <form class="user" action="DishServlet?action=insert" method="POST" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 15%; margin:auto">Dish name:</span><input type="text" name="fullname"  pattern=".{0,30}"class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter..." style="width:85%" required="true">
                                    </div>                                                                     
                                    <!--is Active-->
                                    
                                                    
                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 15%; margin:auto">Price:</span><input type="text" name="price"  pattern=".{0,30}"class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter..." style="width:85%" required="true">
                                    </div>
                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 15%; margin:auto">Unit:</span><input type="text" name="unit"  pattern=".{0,30}"class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter.." style="width:85%" required="true">
                                    </div>
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 15%; margin:auto">Image</span><input type="file" pattern=".{0,30}"  onchange="showMyImage(this)" class="form-control form-control-file" name="image" required="true" style="width:85%"/>
                                    </div>
