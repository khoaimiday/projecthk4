...
<div class="container">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4" style="font-weight: bold">INSERT USER</h1>
                                </div>

                                <form class="user" action="UserServlet?action=insert" method="POST">


                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 15%; margin:auto">user name:</span><input type="text" name="userName"  pattern=".{0,30}"class="form-control"  aria-describedby="emailHelp" placeholder="Enter UserName..." style="width:85%" required="true">
                                    </div>
                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 15%; margin:auto">password:</span><input type="text" name="password"  pattern=".{0,30}"class="form-control" aria-describedby="emailHelp" placeholder="Enter PassWord..." style="width:85%" required="true">
                                    </div>
